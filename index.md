...
which refits the model on a rolling forecast origin and stores the
out-of-sample errors at every horizon:
...
When the five held-back observations arrive,
[`update()`](https://rdrr.io/r/stats/update.html) extends the fit
...
- [Updating conformal forecasts with new
  ...
  how [`update()`](https://rdrr.io/r/stats/update.html) extends a fitted
  pipeline as observations arrive, and when it is equivalent to
  refitting.
